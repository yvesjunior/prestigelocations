...
const fr = {
  ...
  servicesPage: {
    ...
    services: [
      ...
      },
      {
        ...
        text: "Nous livrons l'équipement directement sur votre chantier, partout dans le Centre-du-Québec.",
      },
    ],
  ...
  aboutPage: {
    ...
    values: [
      ...
      {
        title: "Proximité",
        text: "Une entreprise d'ici, au service des gens du Centre-du-Québec.",
      },
    ],
  },
  contactPage: {
...
const en: Dict = {
  ...
  servicesPage: {
    ...
    services: [
      ...
      },
      {
        ...
        text: "We deliver the equipment straight to your job site, anywhere in the Centre-du-Québec region.",
      },
    ],
  ...
  aboutPage: {
    ...
    values: [
      ...
      {
        title: "Community",
        text: "A local business, serving the people of Centre-du-Québec.",
      },
    ],
  },
  contactPage: {
