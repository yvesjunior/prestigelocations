      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground">
            Prestige Locations est votre partenaire de confiance pour la location d'équipements de
            qualité, au meilleur service.
          </p>
        </div>

        <div>
          <h3 className="text-xs font-bold tracking-[0.2em] text-primary uppercase">Navigation</h3>
        ...
        <div>
          <h3 className="text-xs font-bold tracking-[0.2em] text-primary uppercase">Services</h3>
          <ul className="mt-4 space-y-2.5">
            {services.map((s) => (
        ...
        <div>
          <h3 className="text-xs font-bold tracking-[0.2em] text-primary uppercase">Contact</h3>
      ...
      <div className="border-t border-border/60">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-5 sm:flex-row lg:px-8">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Prestige Locations. Tous droits réservés.
          </p>
          <div className="flex items-center gap-3">
            <a
              href="#"
